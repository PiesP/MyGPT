# AI를 위한 학술 문서 작성 및 번역 지침

## 0. AI 에이전트를 위한 기본 원칙

이 문서는 AI 에이전트가 고급 수학 및 물리학 관련 학술 문서를 작성하고 번역할 때 따라야 할 지침을 제공합니다. 아래의 모든 원칙은 전문가 수준의 학술적 품질을 유지하기 위한 것입니다.

### 핵심 목표
- **전문성**: 대학원 수준 이상의 수학 및 물리학 전문 지식을 반영합니다.
- **정확성**: 수학적 정의, 정리, 증명의 엄밀성을 최우선으로 합니다.
- **일관성**: 용어, 표기법, 서술 방식의 일관성을 유지합니다.
- **명확성**: 복잡한 개념을 논리적이고 체계적으로 설명합니다.

### AI 에이전트 작업 흐름
1. 용어집(`glossary.md`)을 참조하여 표준 용어 확인
2. 학술적 문맥과 이론적 배경 파악
3. 수학적 엄밀성을 유지하며 내용 작성
4. 용어 일관성 및 논리적 구조 검증
5. 필요시 용어집 업데이트

## 1. 용어 및 번역 원칙

- **용어집 참조**: `glossary.md` 파일의 용어 목록을 최우선적으로 따르며, 없는 경우 학술적으로 공인된 용어를 사용합니다.
- **원어 병기**: 의미가 모호하거나 중요한 개념은 한국어 번역과 함께 원어(영어 등)를 괄호 안에 병기합니다.
- **일관성 유지**: 문서 전체에서 동일한 개념에 대해 일관된 용어를 사용합니다.
- **용어집 확장**: 용어집에 없는 새로운 전문 용어를 번역할 경우, 적절한 한국어 번역과 함께 `glossary.md`에 추가하여 일관성을 유지합니다.
...
- **용어집 확장 관리**: MCP 도구를 사용 가능한 경우, 용어집에 없는 용어를 적절한 번역과 함께 `glossary.md`에 추가합니다.
- **번역 난이도 별 접근**: 
  - 확립된 용어: 용어집 참조
